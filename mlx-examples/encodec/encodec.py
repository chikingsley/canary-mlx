...
class EncodecResidualVectorQuantizer(nn.Module):
    ...
    def encode(
        self, embeddings: mx.array, bandwidth: float | None = None
    ) -> mx.array:
        """
...
class EncodecModel(nn.Module):
    ...
    def _decode_frame(
        self, codes: mx.array, scale: mx.array | None = None
    ) -> mx.array:
    ...
    def decode(
        ...
        audio_scales: mx.array | list[mx.array],
        ...
        if chunk_length is None:
            ...
            for frame, scale in zip(audio_codes, audio_scales, strict=False):
...
def preprocess_audio(
    raw_audio: mx.array | list[mx.array],
