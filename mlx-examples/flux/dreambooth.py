...
def generate_progress_images(iteration, flux, args):
    ...
    print(f"Generating {out_file!s}", flush=True)
...
if __name__ == "__main__":
    ...
    losses = []
    tic = time.time()
    for i, batch in zip(range(args.iterations), trainer.iterate(args.batch_size), strict=False):
